...
package com.example.play.ui.utils
...
import com.example.play.ui.utils.HorizontalSide.Left
import com.example.play.ui.utils.HorizontalSide.Right
import com.example.play.ui.utils.VerticalSide.Bottom
import com.example.play.ui.utils.VerticalSide.Top
        ...
        get() {
            ...
            return Constraints(
                ...
                maxWidth = when (widthSide) {
                    Left -> insets.left + additionalWidthPx
                    Right -> insets.right + additionalWidthPx
                    null -> Constraints.Infinity
                },
                maxHeight = when (heightSide) {
                    Top -> insets.top + additionalHeightPx
                    Bottom -> insets.bottom + additionalHeightPx
                    null -> Constraints.Infinity
                }
            )
        }
