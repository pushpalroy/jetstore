package com.example.play.ui.appdetails
...
import com.example.play.ui.components.installbutton.animated.AnimatedInstallButton
      ...
      Column(modifier = Modifier.padding(start = 24.dp)) {
        Row {
          ...
          AnimatedProgressIndicator(
              state = getAppRatingBarState(progress = 0.8f, 5000),
              color = PlayTheme.colors.accent
          )
        }
        ...
        Row {
          ...
          AnimatedProgressIndicator(
              state = getAppRatingBarState(progress = 0.3f, 5000),
              color = PlayTheme.colors.accent
          )
        }
        Spacer(modifier = Modifier.height(3.dp))
        ...
        Row {
          ...
          AnimatedProgressIndicator(
              state = getAppRatingBarState(progress = 0.2f, 6000),
              color = PlayTheme.colors.accent
          )
        }
      }
