...
fun ProvidePlayColors(
    ...
    Providers(PlayColorAmbient provides colorPalette, children = content)
}

private val PlayColorAmbient = staticAmbientOf<PlayColorPalette> {
